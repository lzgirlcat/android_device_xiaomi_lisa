...
static const variant_info_t lisa_india_info = {
    ...
    .model = "2109119DI",
    .build_fingerprint = "Xiaomi/lisa_in/lisa:12/RKQ1.211001.001/V13.0.3.0.SKOINXM:user/release-keys",
...
static const variant_info_t lisa_info = {
    ...
    .marketname = "Mi 11 LE",
    .model = "2107119DC",
    .build_fingerprint = "Xiaomi/lisa/lisa:12/RKQ1.211001.001/V13.0.1.0.SKOCNXM:user/release-keys",
